...
public interface UploadTableFields {
	...
	public FieldProperties[] SSRGenotype_Source = {
			...
			new FieldProperties(UploadField.Ploidy.toString(), UploadField.REQUIRED.toString(), "", ""),
	...
	*/
	...
	public FieldProperties[] MTA_Source = {
			...
			new FieldProperties(UploadField.Method.toString(), UploadField.REQUIRED.toString(), "", ""),
			new FieldProperties(UploadField.Score.toString(), UploadField.REQUIRED.toString(), "", ""),
			new FieldProperties(UploadField.Project.toString(), UploadField.REQUIRED.toString(), "", ""),
			new FieldProperties(UploadField.Population.toString(), "", "", ""),
			new FieldProperties(UploadField.PopulationSize.toString(), "", "", ""),
			new FieldProperties(UploadField.PositionUnits.toString(), "", "", ""),
			new FieldProperties(UploadField.Remark.toString(), "", "", "")};		

	public FieldProperties[] MTA_Data = {
			new FieldProperties(UploadField.SNo.toString(), "", "1", "4"),
			new FieldProperties(UploadField.Marker.toString(), UploadField.REQUIRED.toString(), "", ""),
			new FieldProperties(UploadField.Gene.toString(), UploadField.REQUIRED.toString(), "", ""),
			new FieldProperties(UploadField.Chromosome.toString(), UploadField.REQUIRED.toString(), "", ""),
			new FieldProperties(UploadField.Position.toString(), UploadField.REQUIRED.toString(), "", ""),
			new FieldProperties(UploadField.MapName.toString(), UploadField.REQUIRED.toString(), "", ""),				
			new FieldProperties(UploadField.TraitID.toString(), UploadField.REQUIRED.toString(), "", ""),
			new FieldProperties(UploadField.Effect.toString(), UploadField.REQUIRED.toString(), "", ""),
			new FieldProperties(UploadField.ScoreValue.toString(), "", "", ""),	
			new FieldProperties(UploadField.R2.toString(), "", "", ""),
			
			new FieldProperties(UploadField.Allele_A.toString(), UploadField.REQUIRED.toString(), "", ""),
			new FieldProperties(UploadField.Allele_B.toString(), UploadField.REQUIRED.toString(), "", ""),
			
			new FieldProperties(UploadField.Allele_A_Phenotype.toString(), "", "", ""),
			new FieldProperties(UploadField.Allele_B_Phenotype.toString(), "", "", ""),
			new FieldProperties(UploadField.Freq_Allele_A.toString(), "", "", ""),
			new FieldProperties(UploadField.Freq_Allele_B.toString(), "", "", ""),
			new FieldProperties(UploadField.Pvalue_Uncorrected.toString(), "", "", ""),
			new FieldProperties(UploadField.Pvalue_corrected.toString(), "", "", ""),
			new FieldProperties(UploadField.CorrectionMethod.toString(), "", "", ""),
			new FieldProperties(UploadField.TraitAverageForAlleleA.toString(), "", "", ""),
			new FieldProperties(UploadField.TraitAverageForAlleleB.toString(), "", "", ""),
			new FieldProperties(UploadField.Dominance.toString(), "", "", ""),
			new FieldProperties(UploadField.Evidence.toString(), "", "", ""),
			new FieldProperties(UploadField.Reference.toString(), "", "", ""),
			new FieldProperties(UploadField.Notes.toString(), "", "", "")};
}
