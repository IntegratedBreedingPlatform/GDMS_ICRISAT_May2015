...
public class DeleteComponent extends CustomComponent  implements ItemClickListener {
	...
	private void handleDeletion() {
			...
			if(null != item) {
				...
				if(itemProperty.toString().equals("true")) {
					if(openedItemId.equals("Genotyping Data")) {
						...
						String strValue = item.getItemProperty("Program Genotyping Dataset(s)").toString();
						itemsToDelete.add(strValue);
					} else if(openedItemId.equals("Maps")) {
						//String strValue = item.getItemProperty("Map(s) from Local").toString();
						String strValue = item.getItemProperty("Program Map(s)").toString();
						itemsToDelete.add(strValue);
					} else if(openedItemId.equals("QTLs")) {
						//String strValue = item.getItemProperty("QTL(s) from Local").toString();
						String strValue = item.getItemProperty("Program QTL(s)").toString();
						itemsToDelete.add(strValue);
					} else if(openedItemId.equals("MTAs")) {
						//String strValue = item.getItemProperty("QTL(s) from Local").toString();
						String strValue = item.getItemProperty("Program MTA(s)").toString();
						itemsToDelete.add(strValue);
					}
				}
			}
		...
		if(openedItemId.equals("Genotyping Data")) {
			...
			DataDeletionAction dataDeletionAction = new  DataDeletionAction(__mainHomePage);
			if(dataDeletionAction.deleteMTAInfoData(itemsToDelete)) {
				removeItemsFromTable(containerDataSource, iCount);
			}
		}
	...
	private void updateCentralDataTable(){
		...
		if(openedItemId.equals("Genotyping Data")) {
			try {
				...
				_centralTableData.addContainerProperty("Public Genotyping Dataset(s)", String.class, null);
			...
			try {
				...
				_centralTableData.addContainerProperty("Public Map(s)", String.class, null);
			...
			try {
				...
				_centralTableData.addContainerProperty("Public QTL(s)", String.class, null);
			...
			try {
				//centralTableData.addContainerProperty("Select", CheckBox.class, null);
				//_centralTableData.addContainerProperty("QTL(s) from Central", String.class, null);
				_centralTableData.addContainerProperty("Public MTA(s)", String.class, null);
				_dataList = dataDeletionRetrievalAction.getCentralMTAInfoList();
			} catch (Exception e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
...
//		_lblSelectedNodesTree.requestRepaint();
	...
	private void updateTableData() {
		...
		_tableData.removeContainerProperty("MTAs Name");
		...
		_tableData.removeContainerProperty("Program Genotyping Dataset(s)");
		_tableData.removeContainerProperty("Program Map(s)");
		_tableData.removeContainerProperty("Program QTL(s)");
		_tableData.removeContainerProperty("Program MTA(s)");
		...
		if(openedItemId.equals("Genotyping Data")) {
			try {
				_tableData.addContainerProperty("Select", CheckBox.class, null);
				_tableData.addContainerProperty("Program Genotyping Dataset(s)", String.class, null);
			...
			try {
				...
				_tableData.addContainerProperty("Program Map(s)", String.class, null);
				_tableData.setColumnWidth("Select", 40);
			...
			try {
				...
				_tableData.addContainerProperty("Program QTL(s)", String.class, null);
				_tableData.setColumnWidth("Select", 40);
			...
			try {
				_tableData.addContainerProperty("Select", CheckBox.class, null);
				//_tableData.addContainerProperty("QTL(s) from Local", String.class, null);
				_tableData.addContainerProperty("Program MTA(s)", String.class, null);
				_tableData.setColumnWidth("Select", 40);
				_tableData.setColumnWidth("MTAs Name", 1000);
				//_tableData.setColumnExpandRatio("Select", 1.0f);
				//_tableData.setColumnExpandRatio("QTLs Name", 2.0f);
				_dataList = dataDeletionRetrievalAction.getMTAInfoList();
			} catch (Exception e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
